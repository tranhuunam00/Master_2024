...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Đối với 15 câu thuận} (câu 1-5, 7-9, 11-13, 15-17, 20): Điểm số của câu $i$ là:
        \begin{equation}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Tôi cảm thấy thiếu năng lượng.
        \item Mọi việc đòi hỏi tôi phải cố gắng.
        \item Tôi cảm thấy yếu ớt một vài nơi của cơ thể.
        \item Tôi cảm thấy chân hay tay nặng nề.
        \item Tôi cảm thấy mệt mỏi mà không giải thích được.
        \item Tôi mong muốn được nằm nghỉ.
        \item Tôi cảm thấy khó tập trung.
        \item Tôi cảm thấy mệt, nặng nề, trì trệ.
    \end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Bộ câu hỏi gồm 13 câu hỏi nhị phân (Đúng/Sai):}
    \begin{enumerate}
        \item Tôi khó mà thoát ra khỏi những suy nghĩ tồi tệ trong đầu.
        \item Tôi cảm thấy không còn năng lượng.
        \item Tôi không còn thích làm những điều mà trước kia tôi rất yêu thích hoặc quan tâm.
        \item Tôi cảm thấy thất vọng và chán nản bản thân.
        \item Tôi cảm thấy bị ức chế và cản trở khi làm một điều gì đó.
        \item Hiện tại tôi cảm thấy mình kém hạnh phúc hơn những người khác.
        \item Rất buồn chán.
        \item Tôi cảm thấy mình bắt buộc phải cố gắng để làm bất cứ điều gì.
        \item Tinh thần tôi kém sáng suốt so với trước đây.
        \item Hiện tại tôi cảm thấy rất buồn.
        \item Tôi không có khả năng tự quyết định cũng như là điều chỉnh bản thân.
        \item Tôi gặp khó khăn khi thực hiện những công việc mà trước đây tôi thực hiện một cách dễ dàng.
        \item Hiện tại ``đời tôi trống rỗng''.
    \end{enumerate}
    \item \textbf{Cách tính điểm:} Câu trả lời "Đúng" = 1 điểm, "Sai" = 0 điểm.
    \item \textbf{Thuật toán tính tổng điểm:}
    \begin{equation}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item Ông/bà nhìn chung có hài lòng với cuộc sống của mình không?
    ...
    \begin{itemize}
        \item Trạng thái bình thường: $0 \le \text{Score}_{\text{GDS-15}} \le 5$
        \item Nghi ngờ trầm cảm: $6 \le \text{Score}_{\text{GDS-15}} \le 9$
        \item Trầm cảm rõ rệt: $\text{Score}_{\text{GDS-15}} \ge 10$
    \end{itemize}
\end{itemize}
