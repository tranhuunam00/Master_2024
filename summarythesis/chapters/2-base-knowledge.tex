...
\begin{center}
      \textbf{\fontsize{20}{22}\selectfont CHƯƠNG I: TỔNG QUAN OSA, MỐI LIÊN HỆ VỚI TƯ THẾ NGỦ VÀ
...
\noindent\textbf{\fontsize{16}{20}\selectfont 1.1. Hội chứng ngưng thở khi ngủ}

\noindent\textbf{\fontsize{14}{5}\selectfont 1.1.1. Khái niệm}
...
\noindent\textbf{\fontsize{14}{5}\selectfont 1.1.2. Nguyên nhân}
...
\noindent\textbf{\fontsize{14}{5}\selectfont 1.1.3. Ảnh hưởng của OSA}

Uớc tính có gần một tỷ người trên toàn cầu mắc OSA. Tại Việt Nam, theo
GS.TS.BS. Dương Quý Sỹ, tỷ lệ mắc OSA ở người trưởng thành chiếm khoảng 8,5\%.
...
\noindent\textbf{\fontsize{14}{5}\selectfont 1.1.4. Tư thế ngủ và mối liên hệ với OSA}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.2\textwidth]{images/tuthe_osa.png} % giảm xuống 70% chiều rộng trang
      \vspace*{-5mm}
...
\noindent\textbf{\fontsize{16}{20}\selectfont 1.2. Công nghệ trong chẩn đoán OSA và phân loại tư thế
      ngủ}

\noindent\textbf{\fontsize{14}{5}\selectfont 1.2.1. Đa ký giấc ngủ}
...
\noindent\textbf{\fontsize{14}{5}\selectfont 1.2.2. Thiết bị theo dõi OSA tại nhà}

Các thiết bị theo dõi tại nhà (HST) được thiết kế với mục tiêu giảm kích thước,
chi phí phù hợp, thuận tiện sử dụng tại nhà. Để làm được điều đó thì các thiết
bị HST cần phải giảm thiểu số lượng cảm biến nhưng vẫn đảm bảo độ chính xác.
Điều này có thể đạt được thông qua việc tích hợp các thuật toán xử lý tín hiệu
và mô hình học máy có thể được thực thi trực tiếp trên phần cứng nhúng hoặc
thông qua ứng dụng hỗ trợ trên điện thoại di động.

\noindent\textbf{\fontsize{14}{5}\selectfont 1.2.3. Kĩ thuật phân loại tư thế ngủ}
...
bài toán phân loại tư thế ngủ trên biên kèm kèm theo phân tích rõ ràng về hệ
thống thu thập và ý nghĩa của đặc trưng lên mô hình.

\noindent\textbf{\fontsize{14}{5}\selectfont 1.2.4. Cảm biến gia tốc trong đánh giá tư thế ngủ}
...
điện trở, kiểu điện dung và kiểu áp điện. Với nguyên lý như sau:
\begin{figure}[H]
      \centering
      \[
...
\noindent\textbf{\fontsize{14}{5}\selectfont 1.2.5. Học máy trong phân loại OSA và tư thế ngủ}
