...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ble.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{images/flutter.png}
...
xác lập. Ngoài dữ liệu từ 3 trục x, y, z của cảm biến, thời gian tạo và giá trị
ID của người đang dùng cũng bắt buộc phải lưu lại. Việc này đảm bảo việc minh
bạch, dễ đối chiếu và phân tích. Mã nguồn~\ref{format_ble} mô tả việc đẩy dữ
liệu thông qua phương thức HTTP theo lô giúp giảm tạo các kết nối liên tục tới
máy chủ trung tâm. Điều này tăng tính mở rộng lên hàng trăm thiết bị hoặc giá
trị cảm biến khác đẩy lên cùng 1 thời điểm.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[angle=90, width=0.7\textwidth]{images/be_structure.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/master.2025-chuẩn-Trang-3.drawio (2).png}
