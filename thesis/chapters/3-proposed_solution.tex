...
nhất định, mô hình sẽ gán nhãn cho $\mathbf{x}$ là thuộc lớp dương. Ngược lại,
nếu nhỏ hơn ngưỡng, mẫu được phân loại vào lớp âm.
...
đoán, mẫu dữ liệu mới được đưa vào cả $K$ mô hình, và lớp có xác suất dự đoán
cao nhất sẽ được chọn làm kết quả cuối cùng.
...
có $K$ mô hình. Trong quá trình suy luận, mô hình đưa ra xác suất hoặc độ tin
cậy, và lớp có giá trị cao nhất sẽ được chọn.
