...
bị đeo tiếp xúc sử dụng cảm biến gia tốc ba trục, được gắn tạivùng cổ.
(Hình~\ref{position_sensor}). Bảng~\ref{tab:sensor_position} dưới đây so sánh
ưu và nhược điểm của các vị trí gắn cảm biến gia tốc thường gặp.
