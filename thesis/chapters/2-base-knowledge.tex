...
Những bất cập trên đã thúc đẩy sự phát triển của các thiết bị theo dõi giấc ngủ
ngoài trung tâm (Out-of-Center Sleep Testing Devices), còn gọi là thiết bị kiểm
tra giấc ngủ tại nhà (Home Sleep Test – HST). Các thiết bị HST được thiết kế
với số lượng cảm biến tối giản hơn so với PSG, đồng thời tích hợp thuật toán xử
lý và phân tích tín hiệu tự động – được thực thi trực tiếp trên thiết bị hoặc
thông qua phần mềm hỗ trợ – nhằm mang lại giải pháp chẩn đoán OSA thuận tiện và
kinh tế hơn.

Một trong những cấu phần cơ bản khi phát triển hệ thống HST là khung SCOPERA,
bao gồm sáu nhóm thông số chính: Sleep (S) – giấc ngủ, Cardiovascular (C) – tim
mạch, Oximetry (O) – độ bão hòa oxy, Effort (E) – nỗ lực hô hấp, Respiratory
flow (R) – lưu lượng khí hô hấp, và Audio (A) – âm thanh thở. Khung SCOPERA
đóng vai trò là nền tảng cho việc xây dựng và chuẩn hóa các thiết bị HST thế hệ
mới, hướng tới mục tiêu chẩn đoán sớm OSA bằng phương pháp ít xâm lấn và có thể
triển khai rộng rãi trong cộng đồng. Dựa trên đặc điểm hình thái và vị trí gắn
trên cơ thể, các thiết bị này có thể được phân thành các nhóm: vòng tay, đai
ngực, miếng dán, tai nghe, nhẫn thông minh Bảng \ref{tab:wearable_types}.
