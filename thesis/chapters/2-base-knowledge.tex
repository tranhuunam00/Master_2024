...
Hiện nay, có 3 dạng chính của cảm biến gia tốc MEMS (Micro-Electro-Mechanical
Systems) là kiểu điện trở áp, kiểu điện dung và kiểu áp điện.

Đầu tiên, cảm biến MEMS điện trở áp ra đời sớm nhất, có cấu tạo gồm một khối
dầm bằng vật liệu có tính điện trở áp, kèm theo một khối quán tính (mass).
