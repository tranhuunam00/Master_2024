...
và cộng sự \cite{Jeng_osa}, gồm hai thiết bị đeo độc lập sử dụng cảm 
...
bộ thu phát sóng vô tuyến \cite{p_2}. Nền tảng phần cứng của hệ thống sử dụng bộ vi 
...
\label{tab:pipeline_steps}  % <- gắn label ở đây
...
\begin{center}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|p{2cm}|p{2cm}|p{2.5cm}|p{3.2cm}|c|c|c|}
\hline
\textbf{Ref.} & \textbf{Data} & \textbf{Task} & \textbf{Features} & \textbf{Model(s)} & \textbf{Acc.} & \textbf{Soft.} & \textbf{On-Chip} \\
\hline
\cite{abdulsadig2023} & 18 subjects & Sleep posture & 12 time-domain & DT, Extra-Trees, LSTM-NN & $>$98\% & NM & Yes \\
\cite{jeng2021} & Not mentioned & Sleep posture & NM & RF, SVM & 85\% & Yes & No \\
\cite{vu2023} & 561,859 samples & Sleep posture & NM & LSTM\_sq, CNN, MLP, LSTM\_con & $>$99\% & No & No \\
\cite{kwasnicki2018} & 16 subjects & Sleep posture & Mean, 3-axis & Threshold-based & 99.5\% & No & No \\
\cite{elnaggar2023} & 5 subjects & Sleep posture & NM & Threshold-based & $>$99.2\% & No & No \\
\cite{gomes2021} & 8 subjects & Human activity & Mean, Std (6) & KNN, RF, SVM & 97\% & No & No \\
\cite{dao2022} & Public + 20 private & Human activity & 31 time-domain & RF & 97\% & Yes & No \\
\cite{souza2017} & 10 subjects (public) & Human activity & 11 time-domain & KNN, NB, SVM, CTree, RF & 98\% & No & No \\
\hline
\multicolumn{8}{l}{\footnotesize NM = Not Mentioned; DT = Decision Tree; CNN = Convolutional Neural Network; MLP = Multilayer Perceptron;} \\
